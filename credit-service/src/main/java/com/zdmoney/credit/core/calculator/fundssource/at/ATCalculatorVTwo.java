package com.zdmoney.credit.core.calculator.fundssource.at;
 ...
 *
 */
@Component("FS_00003_v2")
public class ATCalculatorVTwo extends ATCalculatorBase implements ICalculator {

	@Override
	public BigDecimal getOnetimeRepaymentAmount(Long loanId, Date currDate, List<LoanRepaymentDetail> repayList) {
		System.out.println("证大爱特 计算器 版本 v2.0");
