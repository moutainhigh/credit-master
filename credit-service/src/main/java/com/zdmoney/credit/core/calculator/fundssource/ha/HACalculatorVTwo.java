package com.zdmoney.credit.core.calculator.fundssource.ha;
 ...
 *
 */
@Component("FS_00005_v2")
public class HACalculatorVTwo extends HACalculatorBase implements ICalculator {

	@Override
	public BigDecimal getOnetimeRepaymentAmount(Long loanId, Date currDate, List<LoanRepaymentDetail> repayList) {
		System.out.println("华澳信托 计算器 版本 v2.0");
