...
/**
 * 证大P2P(直销) 计算器 版本 v2.0
 * 
 * @author Ivan
 *
 */
@Component("FS_00001_v2")
public class ZDCalculatorVTwo extends ZDCalculatorBase implements ICalculator {
	private static final Logger logger = Logger.getLogger(ZDCalculatorVTwo.class);
	@Autowired
	...
	public BigDecimal getOnetimeRepaymentAmount(Long loanId, Date currDate, List<LoanRepaymentDetail> repayList) {
		System.out.println("证大P2P(直销) 计算器 版本 v2.0");
	...
	public void updateRate(LoanBase loanBase, LoanInitialInfo loanInitialInfo,
		...
		try {
			//读取excel文件获取数据
			String excelPath = sysParamDefineService.getSysParamValue("system.thirdparty", "excelPathZD");
			...
			logger.info("☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆证大p2p☆☆☆updateRate错误",e);
		}		
	}
	...
	public Map<String, Object> createLoanRepaymentDetail(LoanBase loanBase, LoanInitialInfo loanInitialInfo, LoanProduct loanProduct) {
		try {
			//读取excel文件获取数据
			String excelPath = sysParamDefineService.getSysParamValue("system.thirdparty", "excelPathZD");//获取excel路径
			logger.info("☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆证大p2p☆☆☆☆excel路径："+excelPath);
			...
			logger.info("☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆证大p2p生成还款计划错误",e);
			throw new PlatformException("☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆证大p2p生成还款计划错误");
		}
		return null;//不用调整精度
	}
	...
	public List<LoanRepaymentDetail> createLoanTrial(LoanBase loanBase, LoanInitialInfo loanInitialInfo,
		...
		try {
			//读取excel文件获取数据
			String excelPath = sysParamDefineService.getSysParamValue("system.thirdparty", "excelPathZD");//获取excel路径
			logger.info("☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆证大p2p计算器excel路径："+excelPath);
			ProdCreditProductTerm prodCreditProductTerm = prodCreditProductTermServiceImpl.findBymap(loanProduct.getTime(),loanInitialInfo.getLoanType(),loanBase.getFundsSources());
			ExcelGetInfo excelGetInfo = new ExcelGetInfo(excelPath, loanInitialInfo,prodCreditProductTerm,loanProduct,loanBase);
			VExcelInfo excelInfo = excelGetInfo.getInfo();
			...
			logger.info("☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆证大p2p试算生成还款计划错误",e);
			throw new PlatformException("☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆证大p2p试算生成还款计划错误");
		}
	}
