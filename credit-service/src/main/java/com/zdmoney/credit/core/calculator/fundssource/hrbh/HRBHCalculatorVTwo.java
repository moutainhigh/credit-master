 ...
 */
@Component("FS_00020_v2")
public class HRBHCalculatorVTwo extends HRBHCalculatorBase implements ICalculator {

	private static final Logger logger = Logger.getLogger(HRBHCalculatorVTwo.class);
    ...
    public void updateRate(LoanBase loanBase, LoanInitialInfo loanInitialInfo,
		...
		try {
			//读取excel文件获取数据
			String excelPath = sysParamDefineService.getSysParamValue("system.thirdparty", "excelPathHRBH");
			...
			e.printStackTrace();
			logger.info("☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆华瑞渤海updateRate错误",e);
		}
    }
    ...
    public Map<String, Object> createLoanRepaymentDetail(LoanBase loanBase, LoanInitialInfo loanInitialInfo, LoanProduct loanProduct) {
		try {
			//读取excel文件获取数据
			String excelPath = sysParamDefineService.getSysParamValue("system.thirdparty", "excelPathHRBH");//获取excel路径
			logger.info("☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆华瑞渤海计算器excel路径："+excelPath);
			...
			logger.info("☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆华瑞渤海生成还款计划错误",e);
			throw new PlatformException("☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆华瑞渤海生成还款计划错误");
		}
		return null;//不用调整精度
    }
	/**
