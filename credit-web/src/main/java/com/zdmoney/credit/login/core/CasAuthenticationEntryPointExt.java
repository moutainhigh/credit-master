...
/**
 * 重写CasAuthenticationEntryPoint类 只修改了commence方法的逻辑，其余方法未修改
 * 
 * @author Ivan
 *
 */
public class CasAuthenticationEntryPointExt implements AuthenticationEntryPoint, InitializingBean {
	...
	public final void commence(final HttpServletRequest servletRequest, final HttpServletResponse response,
		...
		if (BaseController.isAjaxRequest(servletRequest)) {
			/** 未登陆时 返回JSON到前端 **/
