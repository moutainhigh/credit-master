...
<div id="appleReliefInfoPanel" class="easyui-panel"
    ...
    <form id="repayForm" >
      ...
      <table cellpadding="5"  border="0" >
        ...
        <tr>
          <td width="" class="">已还期数<input  readonly="readonly" class="ar_input" name="repayTime" value="${vLoanInfo.time-vLoanInfo.residualTime}"/></td>
          <td width="" class="">已还金额<input  readonly="readonly" class="ar_input" name="repayAmount" data-options="precision:2" value="${repayAmount}"/></td>
        ...
        <tr>
          <td width="" class="">申请减免金额<span id="applyReliefSpan" style="margin-left:10px;"><input style="width:140px" class="ar_input easyui-numberbox" readonly="readonly"  name="applyReliefMoney" id="applyReliefMoney" data-options="precision:2,decimalSeparator:'.',prefix:'',required:true" value="${specialRepaymentApply.applyAmount}"/></span></td>
          <td width="" class="">当前应还<input  readonly="readonly" class="ar_input" name="currAllAmount" value="${offerRepayInfo.currAllAmount}"/></td>
          <td width="" class="">减免后应还<input style="width:155px" readonly="readonly" class="ar_input" data-options="precision:2" name="afterReliefAmount" id="afterReliefAmount" value="${afterReliefAmount}"/></td>
        </tr>
        <tr>
          <td width="" colspan="3" class="">减免原因<span style="margin-left:10px;"><input readonly="readonly" class="easyui-textbox" name="memo" data-options="multiline:true" value="${specialRepaymentApply.memo}"
                                                       style="width: 730px;height:60px;"></span></td>
        </tr>
<%--        <c:if test="${specialRepaymentApply.applicationStatus == '5'}">
          <tr>
            <td width="" class="">实际减免金额<span id="accReliefSpan" style="margin-left:10px;"><input style="width:140px" class="ar_input easyui-numberbox" readonly="readonly"  name="accReliefMoney" id="accReliefMoney" data-options="precision:2,decimalSeparator:'.',prefix:'',required:true" value="${effectiveMoney}"/></span></td>
            <td width="" class="">生效日期<input  readonly="readonly" class="ar_input" name="effectiveDate"  value="${effectiveDate}"/></td>
          </tr>
        </c:if>--%>
        <c:if test="${specialReliefFlag == '0'}">
        <tr>
          <td colspan="3" class="">
            <div style="margin-bottom: 5px">
              <div style="position:absolute;width: 70px;">审批流程</div>
            <div style="margin-left:70px;width: 85%">
