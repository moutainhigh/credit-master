  ...
  <script type="text/javascript">
    importPluginsExt(['panel','combobox','window','layout','datagrid','pagination','form','datebox','validatebox'],'business', function() {
      $(function() {
        ...
        urlJs.push(global.contextPath + '/resources/js/specialRepayment/approveReliefFinish.js');
      ...
      <tr>
        ...
        <td>
          <select class="easyui-combobox" id="applicationStatus" name="applicationStatus" style="width: 173px"  data-options="editable:false,panelHeight:'auto'">
            <option value="">请选择</option>
            <c:forEach var="applyStatuse" items="${applyStatuses}">
              <option value="${applyStatuse.code}">${applyStatuse.value}</option>
            </c:forEach>
          </select>
        </td>
      </tr>
...
<div class="easyui-panel" style="padding: 0px; margin: 0px;"
  ...
  <!-- 表格标签 -->
  <table id="approveReliefFinishDataGrid" class ="easyui-datagrid" data-options=""></table>
