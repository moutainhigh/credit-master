...
<head>
  ...
  <script type="text/javascript">
    importPluginsExt(['panel','combobox','window','layout','datagrid','pagination','datalist'
      ...
      $(function() {
        var urlJs = [];
        urlJs.push(global.contextPath + '/resources/js/loan/queryNotSZputOnRecord.js');
...
<div data-options="border:false,region:'center',noheader:true">
  ...
  <table id="querPutOnRecordNotSZDataGrid" class="easyui-datagrid" data-options="" ></table>
</div>
</body>
</html>
