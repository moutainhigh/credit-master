			...
			'business', function() {
				$(function() {
					...
					urlJs.push(global.contextPath
							+ '/resources/js/loan/LoanAdvanceRepayment.js');
...
<body class="easyui-layout">
    ...
    <input type="hidden" id="isApplyConfirmReceive" name="isApplyConfirmReceive" value="${isApplyConfirmReceive}" />
	<div
			...
			<form id="searchForm" method="post">
				<table style="text-align: right:;">
					<tr>
						...
						<td>身份证号:</td>
						<td><input class="easyui-textbox" validType="idCard" value=""
							type="text" id="personInfo.idnum" name="personInfo.idnum" /></td>
					    <td>合同编号:</td>
