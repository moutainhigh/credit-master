...
<script type="text/javascript">
    importPluginsExt(['panel','combobox','window','layout','datagrid','pagination','datalist'
        ...
        $(function() {
            var urlJs = [];
            urlJs.push(global.contextPath + '/resources/js/operation/loanContractCustomerCsAdmin.js');
            urlJs.push(global.contextPath + '/resources/js/common/csSearchCollectors.js');
            urlJs.push(global.contextPath + '/resources/js/operation/closeBusiness.js');
    ...
    <div id="tb" style="padding:3px;height:30px;">
        <div style="margin-bottom:0px">
            <form id="updateForm" method="post">
                ...
                <label>新客服：</label>
                <input id="newCrmId" name="newCrmId"  class="custComboGrid" configValue="{width:150,baseParm:{employeeType:'催收员,催收管理员',inActive:'t'}}"/>
	        		...
	        		<span style="padding-left: 10px;">关闭营业部：</span>
		        	<input class="easyui-combobox" id="shutshop" name="shutshop" style="width:150px;" data-options="editable:false, multiple:true,panelHeight:'200px'" />
		   			<a href="#" class="easyui-linkbutton" id="saveclose" iconCls="icon-search" plain="true">确认修改</a>
            </form>
        </div>
    </div>
        ...
        <form id="searchForm">
            <table cellpadding="5">
                <tr>
                    ...
                    <td>关店营业部：</td>
                    <td>
                        <select class="easyui-combobox" id="orgId" name="orgId" style="width:150px;" data-options="editable:false,panelHeight:'150px'">
