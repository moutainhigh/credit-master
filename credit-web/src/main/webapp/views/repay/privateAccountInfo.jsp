...
<script type="text/javascript">
    importPluginsExt(['panel','combobox','window','layout','datagrid','pagination','form','datebox','validatebox'],'business', function() {
        $(function() {
            ...
            urlJs.push(global.contextPath + '/resources/js/repay/privateAccountInfo.js');
            urlJs.push(global.contextPath + '/resources/js/repay/privateRec.js');
...
<body class="easyui-layout">
        ...
        <form id="searchForm">
            ...
            <table cellpadding="5">
                <tr>
                    ...
                    <td>对方户名：</td>
                    <td><input class="easyui-textbox" id="secondName" name="secondName" style="width:150px" data-options="validType:'maxLength[25,\'对方户名\']'"/></td>
                </tr>
                <tr>
                    <td>认领日期（起）：</td>
    ...
    <div class="easyui-panel" id="tb" style="padding: 5px; height: 45px;">
        ...
        <sec:authorize ifAnyGranted="/repayment/importPrivateAccountInfo">
            <a href="#" class="easyui-linkbutton" id="importBtn" iconCls="pic_52" plain="true">导入</a>
        </sec:authorize>
        <sec:authorize ifAnyGranted="/repayment/exportPrivateAccountReceiveInfo">
            <a href="#" class="easyui-linkbutton" id="exportReceiveInfoBtn" iconCls="pic_51" plain="true">导出已认领结果</a>
        </sec:authorize>
        <sec:authorize ifAnyGranted="/repayment/exportPrivateAccountSearchResult">
            <a href="#" class="easyui-linkbutton" id="exportSearchResultBtn" iconCls="pic_51" plain="true">导出查询结果</a>
        </sec:authorize>
        <sec:authorize ifAnyGranted="/repayment/updateReceiveTime">
            &nbsp;&nbsp;<a href="#" class="easyui-linkbutton" id="updateReceiveTime" iconCls="icon-edit" plain="true">修改对私领取时间</a>
        </sec:authorize>
    </div>
    ...
    <div id="showRectWin" class="easyui-window" title="对私认领">
