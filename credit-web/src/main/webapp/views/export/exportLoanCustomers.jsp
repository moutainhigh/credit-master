	...
	<head>
		...
		<script type="text/javascript">
			importPluginsExt(['panel','combobox','window','layout','datagrid','pagination','datalist','form','switchbutton','tooltip','validatebox','combogrid'],'business', function() {
				$(function() {
					var urlJs = [];
						urlJs.push(global.contextPath + '/resources/js/export/exportLoanCustomers.js');
				...
				<table style="height: 100%;border-spacing:5px;table-layout:fixed;">
					<tr >
						...
						<td style="width: 160px;text-align: left;">
						   <input class="easyui-datebox" type="text" name="reportDate"  id="reportDate"  value="${reportDate}" style="width: 150px;"></input>
						</td>
					</tr>	
				</table>
			</form>
