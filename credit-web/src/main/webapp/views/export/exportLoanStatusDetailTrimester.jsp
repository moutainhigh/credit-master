	...
	<head>
		...
		<script type="text/javascript">
			importPluginsExt(['panel','combobox','window','layout','datagrid','pagination','datalist','form','switchbutton','tooltip','validatebox','combogrid'],'business', function() {
				$(function() {
					var urlJs = [];
						urlJs.push(global.contextPath + '/resources/js/export/exprotTrimester.js');
	...
	<div data-options="region:'north',split:false,border:true,collapsible:false" style="height: 146px;">
			...
			<form id="conditionForm" style="width: 100%; height: 100%;">
				<table style="height: 100%;border-spacing:5px;table-layout:fixed;">
					<tr >
						...
						<input class="easyui-datebox" type="text" name="reportDate"  id="reportDate"  value="${reportDate}" style="width: 150px;"></input></td>
		...
		<div style="padding: 3px;" class="datagrid-toolbar">
			<div id="bottonBox" style="margin-bottom: 0px">
				<a href="javascript:void(0)" class="easyui-linkbutton" id="submitBtn"  iconCls="icon-search" plain="true" style="width: 60px;">导出</a>
			</div>
		</div>
	</div>
	</body>
