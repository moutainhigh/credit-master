$(function() {
	// 表格数据源地址
	var dataGridUrl = global.contextPath + '/system/SysDictionary/findSysDictionaryList?parentId=' + $("#pId").val();

	var findParent = global.contextPath + '/system/SysDictionary/findParent';

	var insertUrl = global.contextPath + '/system/SysDictionary/saveOrUpdateData';
	...
	function addButEvent() {
		...
		//$('#codeName').textbox({'readonly':false});
		// 重置表单数据
		dataForm.form('clear');
	}
	...
	function updateButEvent() {
		...
		//$('#codeName').textbox({'readonly':true});
